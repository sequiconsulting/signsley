...
// v3.8 - Fixed Certificate Expiration vs Document Integrity + Collapsible Chains
...
// Make handleFile globally accessible for index.html routing
...
function getSignaturesArray(result) {
  // Prefer normalized arrays from backend
  ...
  // Enhanced: Handle multiple signatures with per-signature chains
...
console.log('Signsley - v3.8 Fixed Certificate Expiration vs Document Integrity + Collapsible Chains');